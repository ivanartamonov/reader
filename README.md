...
| Страница имеет все необходимые мета теги: title, keywords, description, h1, OpenGraph разметка для репостов  | ❌  |
...
| При листании страницами, можно кликать в левую и правую область читалки для листания влево и вправо. Тап в центральной области вызывает ActionBar (в моб.версии)  | ❌  |
...
| Приложение можно запустить на localhost | ⚠️Partly |
